...
if __name__ == "__main__":
    ...
    ingredients = readIngredientsDictionary('ingredients_Recipes1M.txt')
    ...
    input_all_list = 'ingredients_Recipes1M.txt'
    output_all_list = 'ingredients_simplified_Recipes1M.txt'
